  ...
  return (
    <PopoverPrimitive
      ...
      className={cn(
        ...
        'data-[entering]:animate-in data-[entering]:fade-in data-[exiting]:animate-out data-[exiting]:fade-out data-[placement=left]:data-[entering]:slide-in-from-right-1 data-[placement=right]:data-[entering]:slide-in-from-left-1 data-[placement=top]:data-[entering]:slide-in-from-bottom-1 data-[placement=bottom]:data-[entering]:slide-in-from-top-1',
        className,
      )}
      {...props}
    >
