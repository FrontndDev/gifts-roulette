...
export const SelectItem = ({
  ...
  return (
    <div className="flex h-[34.8vw] w-[74.63vw] flex-col items-center justify-center rounded-[25px] bg-[#39393933] p-[4.7vw]">
      {!selectedGift ? (
        <div className="flex max-w-[43.5vw] flex-col items-center gap-[2.99vw] text-center text-[4vw] leading-[4vw] font-[400] text-white">
          ...
          <Button
            ...
            className="flex min-h-[8.7vw] w-[8.7vw] items-center justify-center rounded-[15px] bg-[#262626] p-0"
          >
            <Icons.Plus />
          </Button>
        </div>
