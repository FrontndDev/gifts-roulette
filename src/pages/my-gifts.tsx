...
export function MyGiftsPage() {
  ...
  const renderWithdrawView = () => (
    <div className="flex flex-col items-center gap-[20px]">
      <div className="bg-dark-gray-card border-text flex h-[80dvh] w-full flex-col gap-[12px] rounded-2xl border p-[5.21vw_6.64vw_6.22vw]">
        ...
        <div className="flex h-[100%] flex-col gap-[12px] overflow-auto">
          {[1, 2, 3].map((i, idx) => (
            <div
              key={i}
